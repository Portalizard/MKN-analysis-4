...
\begin{remark}
    Видно, что это исчерпывающая классификация. \todo{Приведём примеры} функций с особенностями каждого из типов:
\end{remark}
...
\begin{remark}
    \todo{Пример} про вычисление $\int_{\R} \frac{\cos x}{1 + x^2} dx$ через комплексные интегралы.
\end{remark}
